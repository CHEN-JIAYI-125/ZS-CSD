...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_knowledge_path', type=str, default='data/target_knowledge_template.json')
    parser.add_argument('--target_knowledge_max_chars', type=int, default=120)
    parser.add_argument('--max_seq_length', type=int, default=0)
    parser.add_argument('--use_topology', type=int, default=1)
    parser.add_argument('--topology_loss_weight', type=float, default=0.0)
    parser.add_argument('--topology_alpha', type=float, default=0.1)
    parser.add_argument('--topology_fusion_mode', type=str, default='gated')
    parser.add_argument('--topology_edge_mode', type=str, default='utterance')
    parser.add_argument('--topology_local_window', type=int, default=3)
    parser.add_argument('--topology_glan_branches', type=str, default='global,local,struct,final')
    parser.add_argument('--topology_glan_hop', type=int, default=2)
    parser.add_argument('--topology_glan_lambda', type=float, default=0.5)
    parser.add_argument('--use_relation_context', type=int, default=0)
    parser.add_argument('--relation_context_weight', type=float, default=0.5)
    parser.add_argument('--relation_context_dropout', type=float, default=0.1)
    parser.add_argument('--turn_loss_weight', type=float, default=0.0)
    parser.add_argument('--topology_layers', type=int, default=2)
    parser.add_argument('--topology_dropout', type=float, default=0.1)
    parser.add_argument('--topology_tau', type=float, default=0.2)
    parser.add_argument('--topology_max_pairs', type=int, default=128)
    parser.add_argument('--topology_neutral_weight', type=float, default=0.5)
    parser.add_argument('--topology_favor_against_weight', type=float, default=1.5)
